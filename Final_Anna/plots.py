...
for x in counting(1000):
    ...
    opticaldepth_ana = open('Text_files_two/opticaldepth_ana_nop=%s.txt' % x,'r')
    opticaldepth_num = open('Text_files_two/opticaldepth_num_nop=%s.txt' % x,'r')
    phi = open('Text_files_two/phi.txt', 'r')
    theta = open('Text_files_two/theta.txt', 'r')
    # density_ana = open('Text_files/density_ana_nop=%s.txt' % x, 'r')
    # density_num = open('Text_files/density_num_nop=%s.txt' % x, 'r')
