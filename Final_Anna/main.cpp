...
int main() {
  ...
  //parameters controlling both the analytical density and numerical density distributions
  ...
  for(noparticles=10000.;noparticles<=10000.;(noparticles=noparticles*10.)){//changing the number of particles I populate the grid with
    delete[] T_vec;
