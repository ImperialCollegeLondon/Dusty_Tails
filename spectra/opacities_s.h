...
{
    public:
    void read_data(const char *s_lambda_table, const char *s_size_table,
    ...
    private:
    int lambda_table_length, size_table_length;
    std::vector<double> lambda_table, size_table;
    ...
    double interpolate_2d(const std::vector<std::vector<double>> &opac_table, double A, double L) const;
};
